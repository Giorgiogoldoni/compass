...
BENCHMARK_TICKERS = ["MACV.MI", "MODR.MI", "MAGR.MI", "SWDA.MI", "IEAG.MI"]
BENCHMARK_NOMI = {
...
ETF_UNIVERSE = sorted(set([
    ...
    "EXV1.DE",    "EXX5.DE",    "EXXW.DE",    "FCRN.DE",    "FGEQ.F",     "GOM.MI",
    ...
    "IWDP.MI",    "JNHD.DE",    "JPGL.MI",    "JPNH.MI",    "MACV.MI",    "MAGR.MI",
    ...
    "VAPX.MI",    "VHYL.MI",    "VUSA.MI",    "VWCE.DE",    "WENT.MI",    "WHCS.MI",
    "WRTY.MI",    "WS5X.MI",    "WSPE.MI",    "WSPX.MI",    "WWRD.MI",    "XAIX.MI",
